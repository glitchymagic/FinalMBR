...
def generate_central_report():
    ...
    # Create the workbook
    wb = create_excel_report("Central_Region_June_2025_Report.xlsx")
    ...
    # Save the workbook
    wb.save("Central_Region_June_2025_Report.xlsx")
    print("Central Region report generated successfully!")
