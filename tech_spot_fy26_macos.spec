...
"""
PyInstaller spec file for Tech Spot FY26 Report - macOS
Builds a standalone executable for Mac distribution
"""
...
app = BUNDLE(
    coll,
    name='Tech Spot FY26 Report.app',
    icon=None,
    bundle_identifier='com.techspot.fy26report',
    info_plist={
        'CFBundleDisplayName': 'Tech Spot FY26 Report',
        'CFBundleName': 'Tech Spot FY26 Report',
