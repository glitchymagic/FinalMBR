...
def generate_central_report():
    ...
    # Central Region data with only approved technicians
    central_data = {
        'total_incidents': 749,
        'avg_mttr': 1.3,
        ...
        'locations': [
            ...
            },
            {
                ...
                'sla_compliance': 100.0,
                'fcr_rate': 100.0,
                'technicians': [], # No approved technicians for this location
                'kb_articles': [
    ...
    # Create the workbook
    wb = create_excel_report("Corrected_Central_Region_June_2025_Report.xlsx")
    ...
    # Save the workbook
    wb.save("Corrected_Central_Region_June_2025_Report.xlsx")
    print("Corrected Central Region report generated successfully!")
